...
public class HBaseEventPublisher implements EventPublisher {
    ...
    private final HTable payloadTable;
     ...
     */
    public HBaseEventPublisher(HTable payloadTable, byte[] payloadColumnFamily, byte[] payloadColumnQualifier) {
    ...
    protected HTable getPayloadTable() {
